...
namespace RosShop.Data.Migrations
{
    ...
    [Migration("20190615035615_Add-Migration ui")]
    partial class AddMigrationui
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RosShop.Data.Models.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("RosShop.Data.Models.ModelOfBrands", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("RosShop.Data.Models.Size", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("RosShop.Data.Models.ModelOfBrands", b =>
                {
                    b.HasOne("RosShop.Data.Models.Brand", "Brand")
                        .WithMany("Model")
            ...
            modelBuilder.Entity("RosShop.Data.Models.Product", b =>
                {
                    b.HasOne("RosShop.Data.Models.ShopingCard", "Shoping")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("RosShop.Data.Models.Size", b =>
                {
                    b.HasOne("RosShop.Data.Models.ModelOfBrands", "ModelOfBrand")
                        .WithMany("Size")
                        .HasForeignKey("ModelOfBrandId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
